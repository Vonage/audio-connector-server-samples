...
This project demonstrates how to connect [Vonage Audio Connector](https://developer.vonage.com/en/video/guides/audio-connector) to a Pipecat-powered **OpenAI Realtime speech-to-speech bot** over WebSockets using FastAPI.

It enables real-time bidirectional audio streaming between a Vonage Video API session and an **OpenAI Realtime audio-in / audio-out model**, with correct telephony-grade audio framing.
...
6. **Realtime AI processing:** Incoming audio is streamed directly into OpenAI Realtime, which generates spoken responses and streams audio back continuously
...
### AI Services
- `OPENAI_API_KEY` (used for OpenAI Realtime speech-to-speech inference)
